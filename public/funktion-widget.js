document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const widgetHTML = `
        ...
        <div id="charity-overlay" style="display:none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 1001;">
            <div id="charity-popup" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: #10826c; max-width: 650px; padding: 30px; font-family: 'Open Sans', sans-serif !important; text-align: center; justify-content: center; border-radius: 10px; padding: 30px;">
